...
class SpecBuilderState:
    ...
    def reset_to_empty(self: Self, name: str, version: str) -> None:
        ...
        The spec becomes a fresh empty ``ProfileSpec`` keeping the draft's
        name/version. The editing pointers MUST be cleared too, or the
        persisted state keeps referencing an entity/field that no longer
        exists.
        """
